...
public class AssetTest {
	...
	public AssetTest() throws Exception {
...
//			assertEquals(assetPage.verify_dashboadPage(), "Welcome,");
			...
			GenericFunctions.enterValueInto(loginElement.login_userName,url.userName());
			GenericFunctions.enterValueInto(loginElement.login_password,url.password());
	...
	@Test(priority = 1)
		...
		System.out.println("verify_add_asset_functionality method");
